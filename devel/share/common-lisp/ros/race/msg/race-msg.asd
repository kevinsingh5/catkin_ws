...
(defsystem "race-msg"
  ...
  :components ((:file "_package")
    (:file "detect_values" :depends-on ("_package_detect_values"))
    (:file "_package_detect_values" :depends-on ("_package"))
    ...
    (:file "predict_vals" :depends-on ("_package_predict_vals"))
    (:file "_package_predict_vals" :depends-on ("_package"))
  ))